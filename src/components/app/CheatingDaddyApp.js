        ...
        return html`
            <div class="live-bar">
                <div class="live-bar-left">
                    <button class="live-dot close-dot" @click=${() => this._handleQuitApp()} title="Exit application"></button>
                    <button class="live-dot minimize-dot" @click=${() => this._handleMinimize()} title="Minimize"></button>
